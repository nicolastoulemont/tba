...
import ProfileEventsFeed from './profileSocialFeeds/ProfileEventsFeed';
import ProfileCommentsFeed from './profileSocialFeeds/ProfileCommentsFeed';
import ProfileLikesFeed from './profileSocialFeeds/ProfileLikesFeed';
        ...
        <div className="py-2">
          <div className="row">
            <div className="col pb-5">
              ...
              {commentsDisplay ? (
                <ProfileCommentsFeed user={user} name={name} />
              ) : null}
              {likesDisplay ? (
                <ProfileLikesFeed user={user} name={name} />
              ) : null}
            </div>
          </div>
        </div>
