				...
				<div className="py-2">
					<div className="row">
						<div className="col pb-5">
							{commentsDisplay ? (
								<EventCommentsFeed user={user} event_ID={event_ID} eventCreator={eventCreator} />
							) : null}
							{registreeDisplay ? <EventRegistrationsFeed event_ID={event_ID} /> : null}
						</div>
					</div>
				</div>
			</Fragment>
