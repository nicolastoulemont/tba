		...
		<Fragment>
			...
			<div className="row m-0 py-2 border-bottom">
				<div className="col border-right p-0">
					...
					>
						<small className="d-inline font-weight-bold">Today's</small>
					</Link>
				</div>
				<div className="col border-right p-0">
					<Link
					...
					>
						<small className="d-inline font-weight-bold">Next Three days</small>
					</Link>
				</div>
				<div className="col p-0">
					...
					>
						<small className="d-inline font-weight-bold">Next 7 days</small>
					</Link>
				</div>
			</div>
			<div className="row  m-0 p-0">
