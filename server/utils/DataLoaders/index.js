...
const { batchCommentComments } = require('./BatchFunctions/comments');
...
// COMMENTS LOADERS
const commentCommentsLoader = new Dataloader(ids => batchCommentComments(ids, models));
